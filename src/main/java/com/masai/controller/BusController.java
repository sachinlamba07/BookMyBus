...
public class BusController {
	...
	@PostMapping("/add")
	public ResponseEntity<Bus> addBus(@RequestBody Bus bus,@RequestParam String key)throws BusException, UserException{
	...
	@PutMapping("/update")
	public ResponseEntity<Bus> updateBus(@RequestBody Bus bus,@RequestParam String key)throws BusException, UserException{
	...
	public ResponseEntity<Bus> deleteBus(@PathVariable("busId") Integer busId,@RequestParam String key)throws BusException, UserException{
	...
	public ResponseEntity<Bus> viewBus(@PathVariable("busId") Integer busId,@RequestParam String key) throws BusException, UserException{
	...
	public ResponseEntity<List<Bus>> viewBusByType(@PathVariable("busType") String busType,@RequestParam String key) throws BusException, UserException{
